            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                {sales.length === 0 ? (
                    ...
                    <table className="min-w-full bg-white border-collapse border border-gray-300">
                        <thead>
                            <tr>
                                <th className="py-2 px-4 border-b border-gray-300 text-left text-sm font-semibold text-gray-700">ID Venta</th>
                        ...
                        <tbody>
                            {sales.map(sale => (
                                <tr key={sale.id}>
                                    <td className="py-2 px-4 border-b border-gray-300 text-sm text-gray-500">{sale.id}</td>
                                    ...
                                    <td className="py-2 px-4 border-b border-gray-300 text-sm text-gray-500">{sale.date}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
